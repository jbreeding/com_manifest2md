...
<?php if ($canEdit && $this->item->checked_out == 0): ?>
    ...
    <a class="btn"
       href="<?php echo JRoute::_('index.php?option=com_manifest2md&task=extension.edit&id=' . $this->item->id); ?>"><?php echo JText::_("COM_MANIFEST2MD_EDIT_ITEM"); ?></a>
...
<?php if (JFactory::getUser()->authorise('core.delete', 'com_manifest2md.extension.' . $this->item->id)) : ?>
    ...
    <div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal"
        ...
        <div class="modal-footer">
            ...
            <a href="<?php echo JRoute::_('index.php?option=com_manifest2md&task=extension.remove&id=' . $this->item->id, false, 2); ?>"
