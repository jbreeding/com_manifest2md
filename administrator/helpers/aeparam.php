...
class Manifest2mdHelperParam
{
    ...
    public static function getGlobalParam()
    {
        ...
        if (empty($params['template_config'])) {
            ...
            $params['template_config'] .= '## Object Config {extension}' . PHP_EOL;
            $params['template_config'] .= '{parameters}';
            $params['template_config'] .= 'Once again, thank you so much for downloading our product. As I said at the beginning, I\'d be glad to help you if you have any questions relating to this product. No guarantees, but I\'ll do my best to assist.' . PHP_EOL;
        ...
        if (empty($params['template_model'])) {
            ...
            $params['template_model'] .= '# {extension} Model {object}' . PHP_EOL;
            $params['template_model'] .= '{parameters}';
            $params['template_model'] .= PHP_EOL;
        ...
        if (empty($params['template_view'])) {
            ...
            $params['template_view'] .= '### Configure the Link Menus' . PHP_EOL;
